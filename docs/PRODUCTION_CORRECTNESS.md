...
- Use [ACTIONABLE_ERRORS.md](ACTIONABLE_ERRORS.md) for the diagnostic contract, [HYDRATION.md](HYDRATION.md) for DOM reuse and fallback rules, and [OBSERVABILITY.md](OBSERVABILITY.md) for the currently shipped inspection surfaces.
