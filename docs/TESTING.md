...
This also matches the broader framework boundary already documented in [ECOSYSTEM.md](ECOSYSTEM.md): testing ergonomics are important, but they are companion-package concerns built on public APIs rather than privileged runtime hooks.
...
- [ADOPTION.md](ADOPTION.md#2-testing-recipe)
