...
func buildExportTestSource(parsePackage string, parseComponent string, parseTestName string, parseRecording exportTestRecording) (string, []string, error) {
	...
	parseSource.WriteString("\t\"github.com/monstercameron/GoWebComponents/v6/testkit/render\"\n")
	parseSource.WriteString("\t\"github.com/monstercameron/GoWebComponents/v6/ui\"\n")
