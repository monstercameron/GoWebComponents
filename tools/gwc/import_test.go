...
func TestParseImportedHTMLDocumentComplex(parseT *testing.T) {
	...
	parseMainGo, parseErr := renderImportedMain(parseDocument, "github.com/monstercameron/GoWebComponents/v6")
	if parseErr != nil {
