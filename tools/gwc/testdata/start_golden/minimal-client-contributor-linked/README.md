...
```powershell
go run ./tools/gwc dev -app "//generated//golden-linked-client//main.go" -root "//generated//golden-linked-client" -html "//generated//golden-linked-client//index.html" -wasm "bin/main.wasm"
```
