...
func App() ui.Node {
	...
	return html.Div(html.Props{Class: "shell"},
		html.Div(html.Props{Class: "panel"},
			...
			html.H1(html.Props{}, html.Text("golden-linked-client")),
			html.P(html.Props{Class: "lede"}, html.Text("Golden output for the contributor-linked scaffold.")),
			html.Div(html.Props{Class: "meta-grid"},
				...
				html.Div(html.Props{Class: "meta-card"},
					...
					html.Strong(html.Props{}, html.Text("github.com/example/golden-linked-client")),
				),
			),
