...
func TestOffThreadClientDoesNotLinkTheEngine(parseT *testing.T) {
	parseDeps := listDeps(parseT, "js", "wasm", "github.com/monstercameron/GoWebComponents/v6/db/offthread")
...
func TestOffThreadServerDoesLinkTheEngine(parseT *testing.T) {
	parseDeps := listDeps(parseT, "js", "wasm", "github.com/monstercameron/GoWebComponents/v6/db/offthread/server")
...
func TestConventionalSQLiteDoesNotPullTheOffThreadClient(parseT *testing.T) {
	for _, parseDep := range listDeps(parseT, "js", "wasm", "github.com/monstercameron/GoWebComponents/v6/db/sqlite") {
		if strings.HasPrefix(parseDep, "github.com/monstercameron/GoWebComponents/v6/db/offthread") {
...
func TestOffThreadClientHasNoDatabaseSQLDependency(parseT *testing.T) {
	for _, parseDep := range listDeps(parseT, "js", "wasm", "github.com/monstercameron/GoWebComponents/v6/db/offthread") {
