...
import (
	...
	"github.com/monstercameron/GoWebComponents/v4/virtualization"
)
...
func main() {
	...
	if exampleboot.HasExampleMountSelector() {
		exampleboot.RenderExampleRoot(ui.CreateElement(virtualizedFeedExample))
