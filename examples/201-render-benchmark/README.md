...
- `http://127.0.0.1:8090/examples/201-render-benchmark/?runtime2WorkerCounts=1,2,4,8&runtime2CoreFastPath=off` to force worker RPC on small core batches (disables the default local core fast path for A/B checks)
