...
const appPackage = "github.com/monstercameron/GoWebComponents/v4/examples/v5-two-artifact/app"
const servicesPackage = "github.com/monstercameron/GoWebComponents/v4/examples/v5-two-artifact/services"
