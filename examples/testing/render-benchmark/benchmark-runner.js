(function () {
    ...
    function buildRunnerSubjectConfigs(parseConfig) {
        ...
        // runtime2 was retired in v5 (P5.2): component bodies measured ~11% of a
        // render pass, well under the 35% bar at which parallelizing them could pay.
        // Its arms are gone rather than left in place, because the modes now fall
        // through to the runtime1 path and would report runtime1 under a runtime2
        // label — numbers that look measured and mean nothing.
        return getSubjects;
    }
