...
- Use [fine-grained-reactivity.md](fine-grained-reactivity.md) when the question is whether a narrow subscribed-region update is worth the extra machinery.
- Use [wasm-build-profiles-and-release-engineering.md](wasm-build-profiles-and-release-engineering.md) and [wasm-build-experiments.md](wasm-build-experiments.md) when the question is bundle profile, release flags, or artifact policy rather than raw runtime cost.
...
For the broader build-profile, size-budget, and release-artifact policy around those measurements, see [wasm-build-profiles-and-release-engineering.md](wasm-build-profiles-and-release-engineering.md) and [wasm-build-experiments.md](wasm-build-experiments.md).
