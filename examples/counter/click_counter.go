...
func ClickCounterExample() {
	...
	fmt.Println("🔍 ClickCounterExample: Searching for DOM container with id 'app'...")
	...
	if container.IsUndefined() || container.IsNull() {
		fmt.Println("❌ ClickCounterExample: ERROR - No element with id 'app' found in the DOM!")
		fmt.Println("💡 ClickCounterExample: Make sure your HTML has a <div id='app'></div> element")
