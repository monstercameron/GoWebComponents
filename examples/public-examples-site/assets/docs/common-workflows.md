...
- When you need realistic app-shape reading paths rather than task slices, use [WALKTHROUGHS.md](end-to-end-walkthroughs.md).
...
- [REFERENCE_MAP.md](reference-map.md#ssr-and-hydration)
...
- [examples/public/counter](../examples/public/counter)
- [examples/server/render-to-string](../examples/server/render-to-string)
- [examples/server/server-side-rendering-routing](../examples/server/server-side-rendering-routing)
...
- If the app uses route or component splitting, keep chunk naming and discovery in the same manifest-driven pipeline; see [CODE_SPLITTING.md](code-splitting-and-bundle-loading.md) and [ASSETS.md](assets.md).
...
- [HYDRATION.md](hydration.md)
- [TROUBLESHOOTING.md](troubleshooting.md#hydration-mismatch-warnings)
- [REFERENCE_MAP.md](reference-map.md#diagnostics-and-debugging)
