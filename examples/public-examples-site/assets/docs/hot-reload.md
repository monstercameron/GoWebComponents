...
```bash
./tools/dev.sh ./examples/public/hot-reload/main.go ./examples/public/hot-reload ./examples/public/hot-reload/hot-reload.html
```
...
- `examples/public/hot-reload`: smallest end-to-end hot reload sandbox
- `test/testapp/main.go`: regression app that exercises state restore, effect cleanup, and failure recovery
- `examples/public/portfolio-site`: larger routed app that enables the public `hotreload` package
...
- `ui/*_wasm.go`
- `examples/server/atlas-commerce-os/shared/atlas/interaction_hooks_wasm.go`
