...
- `examples/public/browser-interop`
- `examples/public/worker-text-index`
- `examples/public/multi-window-console`
- `examples/public/multi-client-presence`
- `examples/public/multi-client-binary`
- `examples/public/web-components`
- `examples/public/cross-tab-sync`
- `docs/CROSS_TAB.md`
