...
- stronger adoption and ecosystem documentation through [ADOPTION.md](adoption-baseline.md) and [ECOSYSTEM.md](ecosystem-and-extension-model.md)
- explicit companion-package story for integrations such as `head` and the experimental `plugin` host
- continued performance work, including fine-grained reactivity and runtime benchmarks documented in [FINE_GRAINED_REACTIVITY.md](fine-grained-reactivity.md) and [PERFORMANCE.md](performance-notes.md)
...
- team-scale and adoption-maturity backlog items remain open in [TODO.md](gowebcomponents-todo.md)
...
- compile-assisted features are explicitly optional and experimental, as documented in [COMPILER_ASSISTED_FEATURES.md](compiler-assisted-features.md)
...
- the fine-grained direction is now explicit in [FINE_GRAINED_REACTIVITY.md](fine-grained-reactivity.md)
...
- hydration, bootstrap transfer, and SSR boundaries are being specified more precisely in [HYDRATION.md](hydration.md), [STATE_TRANSFER.md](state-transfer.md), and [SERVER_INTEGRATION.md](server-integration.md)
- startup, build, and release tradeoffs continue to be measured in [BUILD_EXPERIMENTS.md](wasm-build-experiments.md) and [WASM_RELEASES.md](wasm-build-profiles-and-release-engineering.md)
...
- [PERFORMANCE.md](performance-notes.md)
