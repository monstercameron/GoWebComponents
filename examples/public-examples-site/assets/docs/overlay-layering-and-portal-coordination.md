...
- `examples/public/overlay-stack`: nested dialog plus popover dismissal and focus routing
- `examples/public/overlay-anchor`: menu plus tooltip layering across selector and explicit portal roots
