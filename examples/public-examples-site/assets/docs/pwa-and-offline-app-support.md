...
- Use [offline-mutation-queueing.md](offline-mutation-queueing.md) for replay semantics, [assets.md](assets.md) for cache and manifest alignment, and [browser-support.md](browser-support.md) for capability-gated behavior.
