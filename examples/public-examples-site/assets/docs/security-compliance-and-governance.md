...
The reference example for this boundary is `examples/server/server-side-rendering-secure-forms`, which demonstrates request-time rendering, CSRF-aware posts, multipart validation, and post-submit redirects.
