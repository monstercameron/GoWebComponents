		...
		Div(Class(parseCardClass),
			Div(Class(parseHeaderClass),
				Div(Class("space-y-2"),
					...
					P(Class("max-w-md text-sm leading-6 text-slate-300"), Text("Reactive state, stable handlers, and direct DOM output from Go in the same design language as public-examples-site.")),
				),
