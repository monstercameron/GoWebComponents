		...
		html.Section(html.Props{Class: "mt-8"},
			html.Div(html.Props{Class: "rounded-[2rem] border border-white/10 bg-white/5 p-6"},
				...
				html.Div(html.Props{Class: "flex flex-wrap items-center gap-3"},
					...
					html.Tag("details", html.Props{Class: "min-w-[18rem] rounded-2xl border border-white/10 bg-slate-950/55"},
						html.Tag("summary", html.Props{Class: "cursor-pointer list-none rounded-2xl px-4 py-3 text-sm font-semibold text-slate-100"}, html.Text("Framework features: "+featureSummaryLabel(selectedFeatures.Get()))),
