...
func TestGeneratedMessagesExposeNoArgMethodsAndNilSafeGetters(parseT *testing.T) {
	parseMessages := []interface{}{
		...
		&LogTailEntry{},
		&GetLogTailResponse{},
		&ServerToolPolicyRule{},
		&GetServerToolPolicyRequest{},
		&GetServerToolPolicyResponse{},
		&SetServerToolPolicyRequest{},
		&SetServerToolPolicyResponse{},
		&RunServerToolStart{},
		&RunServerToolStdin{},
		&RunServerToolSignal{},
		&RunServerToolClose{},
		&RunServerToolRequest{},
		&RunServerToolStarted{},
		&RunServerToolOutput{},
		&RunServerToolExit{},
		&RunServerToolError{},
		&RunServerToolEvent{},
