...
func TestBootstrapAndLegacyHelpersCoverRouteVariants(parseT *testing.T) {
	...
	for _, parsePath := range []string{
		...
		RouteComments,
		RouteCommentsModeration,
		RouteCommentDetail,
		RouteSettings,
		RouteSettingsAppearance,
		RouteSettingsLocale,
		RouteSettingsWorkspaceDefaults,
		"/unknown",
	} {
	...
	parseStartupCases := map[string]string{
		...
		RouteCommentsModeration:        "/api/app/comments?status=pending",
		RouteCommentDetail:             "/api/app/comments",
		RouteSettings:                  "/api/app/settings",
		RouteSettingsAppearance:        "/api/app/settings",
		RouteSettingsLocale:            "/api/app/settings",
		RouteSettingsWorkspaceDefaults: "/api/app/settings",
	}
