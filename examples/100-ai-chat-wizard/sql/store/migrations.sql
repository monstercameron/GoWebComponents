...
CREATE TABLE IF NOT EXISTS auth_oidc_states (
    ...
    state_token_hash           TEXT NOT NULL DEFAULT '',
    nonce_token_hash           TEXT NOT NULL DEFAULT '',
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_auth_oidc_states_state_token_hash ON auth_oidc_states(state_token_hash);
