...
var chatWizardBundle = func() *i18n.Bundle {
	...
	bundle.Register("en", i18n.Catalog{
		chatI18nNamespace: {
			...
			"modal.speechProviderTitle":          {Text: "Use OpenAI for speech?"},
			"modal.speechProviderBody":           {Text: "Your current provider does not support speech synthesis. Switch to OpenAI for this feature and save it as your preferred provider/model?"},
			"modal.speechProviderConfirm":        {Text: "Switch to OpenAI"},
	...
	bundle.Register("es", i18n.Catalog{
		chatI18nNamespace: {
			...
			"modal.speechProviderTitle":          {Text: "Usar OpenAI para voz?"},
			"modal.speechProviderBody":           {Text: "Tu proveedor actual no admite sintesis de voz. Quieres cambiar a OpenAI para esta funcion y guardarlo como proveedor/modelo preferido?"},
			"modal.speechProviderConfirm":        {Text: "Cambiar a OpenAI"},
	...
	bundle.Register("fr", i18n.Catalog{
		chatI18nNamespace: {
			...
			"modal.speechProviderTitle":          {Text: "Utiliser OpenAI pour la voix ?"},
			"modal.speechProviderBody":           {Text: "Le fournisseur actuel ne prend pas en charge la synthese vocale. Voulez-vous passer a OpenAI pour cette fonction et l'enregistrer comme fournisseur/modele prefere ?"},
			"modal.speechProviderConfirm":        {Text: "Passer a OpenAI"},
