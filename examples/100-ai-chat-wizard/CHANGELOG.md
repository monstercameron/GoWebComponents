...
- files changed: `test/playwrightgo/examples/example100_admin_ops_workflow_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
...
- files changed: `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/server/app/admin_business_ops.go`, `examples/100-ai-chat-wizard/server/app/admin_business_ops_test.go`, `examples/100-ai-chat-wizard/server/app/store_growth_ops.go`, `examples/100-ai-chat-wizard/server/app/queries.go`, `examples/100-ai-chat-wizard/sql/store/list_product_analytics_events_by_user.sql`, `examples/100-ai-chat-wizard/sql/store/list_subscription_churn_feedback_by_customer.sql`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
...
- files changed: `test/playwrightgo/examples/example100_admin_providers_workflow_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test -c -tags playwrightgo -o ./bin/example100_playwright_examples.test ./test/playwrightgo/examples`
...
- files changed: `test/playwrightgo/examples/example100_admin_chats_workflow_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test -c -tags playwrightgo -o ./bin/example100_playwright_examples.test ./test/playwrightgo/examples`
...
- files changed: `test/playwrightgo/examples/example100_admin_customers_workflow_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test -c -tags playwrightgo -o ./bin/example100_playwright_examples.test ./test/playwrightgo/examples`
...
- files changed: `test/playwrightgo/examples/example100_admin_business_workflow_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test -c -tags playwrightgo -o ./bin/example100_playwright_examples.test ./test/playwrightgo/examples`
...
- files changed: `examples/100-ai-chat-wizard/server/app/admin_dashboard.go`, `examples/100-ai-chat-wizard/server/app/superuser_control.go`, `examples/100-ai-chat-wizard/server/app/admin_support_ops.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "^$" -count=1`
...
- files changed: `test/playwrightgo/examples/example100_dashboard_drilldown_smoke_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test -c -tags playwrightgo -o ./bin/example100_playwright_examples.test ./test/playwrightgo/examples`
...
- files changed: `test/playwrightgo/examples/example100_admin_detail_routes_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test -c -tags playwrightgo -o ./bin/example100_playwright_examples.test ./test/playwrightgo/examples`
...
- files changed: `test/playwrightgo/examples/example100_admin_mutation_diagnostics_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test -c -tags playwrightgo -o ./bin/example100_playwright_examples.test ./test/playwrightgo/examples`
...
- files changed: `test/playwrightgo/examples/example100_dashboard_home_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test -c -tags playwrightgo -o ./bin/example100_playwright_examples.test ./test/playwrightgo/examples`
...
- files changed: `test/playwrightgo/examples/example100_admin_list_mechanics_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test -c -tags playwrightgo -o ./bin/example100_playwright_examples.test ./test/playwrightgo/examples`
...
- files changed: `examples/100-ai-chat-wizard/OPERATOR_RUNBOOK.md`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/client/app -count=1`
...
- files changed: `examples/100-ai-chat-wizard/DESIGN.md`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/client/app -count=1`
...
- files changed: `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/rpc_more_unit_test.go`, `examples/100-ai-chat-wizard/client/app/conversations.go`, `examples/100-ai-chat-wizard/client/app/helpers.go`, `examples/100-ai-chat-wizard/client/app/sidebar.go`, `examples/100-ai-chat-wizard/client/app/app_shell.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "^(TestListConversationsPagination|TestListAndLoadConversationBranches)$" -count=1`; `go test ./examples/100-ai-chat-wizard/proto -count=1`; `go test ./examples/100-ai-chat-wizard/client/app -run "^TestHasScrollSpaceBelow$" -count=1`; `GOOS=js GOARCH=wasm go test -c -o ./bin/example100_client_app_wasm.test ./examples/100-ai-chat-wizard/client/app`
...
- files changed: `examples/100-ai-chat-wizard/client/app/composer.go`, `examples/100-ai-chat-wizard/client/app/panel.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/client/app -count=1`
...
- files changed: `examples/100-ai-chat-wizard/client/app/constants.go`, `examples/100-ai-chat-wizard/client/app/stream.go`, `examples/100-ai-chat-wizard/client/app/app_shell.go`, `examples/100-ai-chat-wizard/client/app/panel.go`, `examples/100-ai-chat-wizard/client/app/thread.go`, `examples/100-ai-chat-wizard/client/app/empty_state.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/client/app -count=1`
...
- files changed: `examples/100-ai-chat-wizard/client/app/app_shell.go`, `examples/100-ai-chat-wizard/client/app/panel.go`, `examples/100-ai-chat-wizard/client/app/thread.go`, `examples/100-ai-chat-wizard/client/app/composer.go`, `examples/100-ai-chat-wizard/client/app/bubble.go`, `examples/100-ai-chat-wizard/client/app/styles.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/client/app -count=1`
...
- files changed: `examples/100-ai-chat-wizard/client/app/bubble.go`, `examples/100-ai-chat-wizard/client/app/styles.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `GOOS=js GOARCH=wasm go test -c -o ./bin/example100_client_palette_tune_wasm.test ./examples/100-ai-chat-wizard/client/app`
...
- files changed: `examples/100-ai-chat-wizard/client/app/helpers.go`, `examples/100-ai-chat-wizard/client/app/conversations.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/client/app -run "^TestHasScrollSpaceBelow$" -count=1`; `GOOS=js GOARCH=wasm go test -c -o ./bin/example100_client_app_wasm.test ./examples/100-ai-chat-wizard/client/app`
...
- files changed: `examples/100-ai-chat-wizard/client/app/app_shell.go`, `examples/100-ai-chat-wizard/client/app/sidebar.go`, `examples/100-ai-chat-wizard/client/app/composer.go`, `examples/100-ai-chat-wizard/client/app/bubble.go`, `examples/100-ai-chat-wizard/client/app/avatar.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `GOOS=js GOARCH=wasm go test -c -o ./bin/example100_client_surface_refresh_wasm.test ./examples/100-ai-chat-wizard/client/app`
...
- files changed: `examples/100-ai-chat-wizard/client/app/thread.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `GOOS=js GOARCH=wasm go test -c -o ./bin/example100_client_app_wasm.test ./examples/100-ai-chat-wizard/client/app`; `go test -c -tags playwrightgo -o ./bin/example100_playwright_examples.test ./test/playwrightgo/examples`
...
- files changed: `examples/100-ai-chat-wizard/client/app/journey_state.go`, `examples/100-ai-chat-wizard/client/app/journey_state_wasm_test.go`, `examples/100-ai-chat-wizard/client/app/panel.go`, `examples/100-ai-chat-wizard/client/app/composer.go`, `examples/100-ai-chat-wizard/client/app/thread.go`, `examples/100-ai-chat-wizard/client/app/empty_state.go`, `examples/100-ai-chat-wizard/client/app/landing_hero.go`, `examples/100-ai-chat-wizard/client/app/pricing_shell.go`, `examples/100-ai-chat-wizard/client/app/auth_shell.go`, `examples/100-ai-chat-wizard/client/app/signup_shell.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `GOOS=js GOARCH=wasm go test -c -o ./bin/example100_client_journey_wasm.test ./examples/100-ai-chat-wizard/client/app`
...
- files changed: `examples/100-ai-chat-wizard/client/app/avatar.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `GOOS=js GOARCH=wasm go test -c -o ./bin/example100_client_app_wasm.test ./examples/100-ai-chat-wizard/client/app`
...
- files changed: `test/playwrightgo/examples/example100_admin_ops_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
...
- files changed: `test/playwrightgo/examples/example100_admin_mutation_pending_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
...
- files changed: `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/server/app/admin_readonly_report_ops.go`, `examples/100-ai-chat-wizard/server/app/admin_readonly_report_ops_test.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AdminMutationDisableAndRestoreEnforcesImmediateAuthEffects|AdminMutationSuspendAndRestoreWorkspaceEnforcesImmediateAuthEffects|AdminMutationDiagnosticsLogs|GetAdminReadOnlyReportAllowlistedSlices|GetAdminReadOnlyReportScopeAndGuards)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run ^$ -bench "Benchmark(ParseNormalizeAdminReadOnlyReportKey|ParseBuildAdminMutationScopeLabel)$" -benchtime=100x`; `go test ./examples/100-ai-chat-wizard/proto -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/queries.go`, `examples/100-ai-chat-wizard/server/app/store_superuser_reliability.go`, `examples/100-ai-chat-wizard/server/app/superuser_reliability_ops.go`, `examples/100-ai-chat-wizard/server/app/superuser_reliability_ops_test.go`, `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, reliability/trust SQL files under `examples/100-ai-chat-wizard/sql/store/` for SSO, retention, compliance, SLO, incident, and incident-update get/list/upsert/delete paths, plus `examples/100-ai-chat-wizard/TODO.md` and `examples/100-ai-chat-wizard/CHANGELOG.md`.
- validation run: `protoc --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative proto/chat.proto` (run in `examples/100-ai-chat-wizard`); `go test ./examples/100-ai-chat-wizard/proto -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreSuperuserReliabilityControlFuncs|SuperuserReliabilityControlRPCs|StoreSuperuserPricingControlFuncs|SuperuserPricingControlRPCs|SuperuserPricingControlRPCsRequireSURole)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(GetSuperuserControlPlaneReturnsSnapshot|GetSuperuserSlicesReturnsSnapshot|StoreSuperuserControlPlaneLifecycle|StoreSuperuserReliabilityControlFuncs|SuperuserReliabilityControlRPCs)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run ^$ -bench "Benchmark(ParseNormalizeSuperuserIncidentStatus|ParseNormalizeSuperuserBillingEnforcementMode)$" -benchtime=100x`
...
- files changed: `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/server/app/queries.go`, `examples/100-ai-chat-wizard/server/app/store_superuser_pricing.go`, `examples/100-ai-chat-wizard/server/app/superuser_pricing_ops.go`, `examples/100-ai-chat-wizard/server/app/superuser_pricing_ops_test.go`, `examples/100-ai-chat-wizard/sql/store/upsert_billing_plan_overage.sql`, `examples/100-ai-chat-wizard/sql/store/delete_billing_plan_overage.sql`, `examples/100-ai-chat-wizard/sql/store/upsert_billing_quota_policy.sql`, `examples/100-ai-chat-wizard/sql/store/delete_billing_quota_policy.sql`, `examples/100-ai-chat-wizard/sql/store/upsert_billing_upgrade_trigger.sql`, `examples/100-ai-chat-wizard/sql/store/delete_billing_upgrade_trigger.sql`, `examples/100-ai-chat-wizard/sql/store/upsert_billing_dunning_event.sql`, `examples/100-ai-chat-wizard/sql/store/get_billing_dunning_event_by_id.sql`, `examples/100-ai-chat-wizard/sql/store/delete_billing_dunning_event.sql`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `protoc --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative proto/chat.proto` (run in `examples/100-ai-chat-wizard`); `go test ./examples/100-ai-chat-wizard/proto -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(SuperuserPricingControlRPCs|SuperuserPricingControlRPCsRequireSURole|GetSuperuserSlicesReturnsSnapshot|GetSuperuserControlPlaneReturnsSnapshot|GetSuperuserControlPlaneReturnsExtendedOperationalSnapshot)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/admin_billing_ops.go`, `examples/100-ai-chat-wizard/server/app/superuser_control.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard_test.go`, `examples/100-ai-chat-wizard/server/app/admin_support_ops_test.go`, `examples/100-ai-chat-wizard/server/app/admin_billing_ops_test.go`, `examples/100-ai-chat-wizard/server/app/superuser_control_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AdminUserListQueryRPCs|AdminSupportTriageListQueryRPCs|AdminBillingListQueryRPCs|GetSuperuserSlicesAppliesListQueries|GetSuperuserSlicesAppliesTypedListQueries|AdminBillingInterventionRPCs|AdminSupportTriageRPCs|AdminUserControlRPCs)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run ^$ -bench "Benchmark(ParseFilterAdminBillingEventRows|ParseFilterSuperuserWorkspaceRows)$" -benchtime=100x`
...
- completed todo: Add typed search, filter, sort, and pagination support for admin user, workspace, support, incident, and billing list RPCs so large datasets are operable without loading everything at once.
- files changed: `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/server/app/admin_list_query.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard.go`, `examples/100-ai-chat-wizard/server/app/admin_support_ops.go`, `examples/100-ai-chat-wizard/server/app/admin_billing_ops.go`, `examples/100-ai-chat-wizard/server/app/superuser_control.go`, `examples/100-ai-chat-wizard/server/app/admin_list_query_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/proto -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AdminListQueryUsersUsageConversations|AdminListQuerySupportBilling|SuperuserSlicesListQuery|StoreAdminSupportTriageFuncs|AdminSupportTriageRPCs|AdminSupportTriageRPCsWorkspaceAdminScope|StoreAdminControlMutationFuncs|AdminControlOpsRPCs|AdminControlOpsWorkspaceScope|StoreAdminBillingInterventionFuncs|AdminBillingInterventionRPCs|AdminDashboardRPCs|AdminDashboardRPCsWorkspaceAdminScope|GetSuperuserSlicesReturnsSnapshot)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "^$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/sql/store/update_incident_status.sql`, `examples/100-ai-chat-wizard/server/app/queries.go`, `examples/100-ai-chat-wizard/server/app/store_admin.go`, `examples/100-ai-chat-wizard/server/app/admin_control_ops.go`, `examples/100-ai-chat-wizard/server/app/admin_control_ops_test.go`, `examples/100-ai-chat-wizard/server/app/admin_support_ops_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreAdminControlMutationFuncs|AdminControlOpsRPCs|AdminControlOpsWorkspaceScope|AdminControlMutationScopeBoundaries|StoreAdminSupportTriageFuncs|AdminSupportTriageRPCs|AdminSupportTriageRPCsWorkspaceAdminScope)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run ^$ -bench "Benchmark(ParseNormalizeAdminBillingQuotaOverrideKey|ParseBuildAdminSupportTicketEntry|ParseHasAdminIncidentResolvedStatus)$" -benchtime=100x`
...
- files changed: `examples/100-ai-chat-wizard/server/app/store_admin.go`, `examples/100-ai-chat-wizard/server/app/admin_support_ops.go`, `examples/100-ai-chat-wizard/server/app/admin_support_ops_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreAdminSupportTriageFuncs|AdminSupportTriageRPCs|AdminSupportTriageRPCsWorkspaceAdminScope)$" -count=1`
...
- completed todo: Add typed support-triage funcs and RPCs for ticket queues, ticket detail, internal notes, assignment, escalation, and account-linked action history.
- files changed: `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/server/app/store_admin.go`, `examples/100-ai-chat-wizard/server/app/admin_support_ops.go`, `examples/100-ai-chat-wizard/server/app/admin_support_ops_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreAdminSupportTriageFuncs|AdminSupportTriageRPCs|StoreAdminBillingInterventionFuncs|AdminBillingInterventionRPCs|AdminUserControlRPCs|AdminUserControlRPCsWorkspaceAdminScope|GetWorkspaceAdminSlices|BillingInterventionOpsSuperuserFlow|BillingInterventionOpsWorkspaceScopeDenied)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run ^$ -bench "Benchmark(ParseNormalizeAdminBillingQuotaOverrideKey|ParseBuildAdminSupportTicketEntry)$" -benchtime=100x`
...
- files changed: `examples/100-ai-chat-wizard/server/app/billing_intervention_ops.go`, `examples/100-ai-chat-wizard/server/app/billing_intervention_ops_test.go`, `examples/100-ai-chat-wizard/server/app/workspace_admin_ops.go`, `examples/100-ai-chat-wizard/server/app/workspace_admin_ops_test.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects_test.go`, `examples/100-ai-chat-wizard/server/app/runtime_access_policy_test.go`, `examples/100-ai-chat-wizard/server/app/billing_admin_rpc_test.go` (removed), `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `$env:GOCACHE=(Resolve-Path '.\\bin').Path + '\\gocache-temp'; go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreAdminBillingInterventionFuncs|AdminBillingInterventionRPCs|BillingInterventionOpsSuperuserFlow|BillingInterventionOpsWorkspaceScopeDenied|WorkspaceAdminOpsDetailAndMutations|WorkspaceAdminOpsDenyOutOfScope|AdminMutationRestoreUserPreservesNonDisableAuthBlocks|AdminMutationRestoreWorkspaceDoesNotReopenRevokedOrDisabledOverrides|UserScopedWritesBlockedWhenAuthBlocked)$" -count=1`
...
- completed todo: Add typed billing-intervention funcs and RPCs for quota overrides, access overrides, failed-payment resolution, dunning review, and billing-event inspection.
- files changed: `examples/100-ai-chat-wizard/server/app/billing_intervention_ops.go`, `examples/100-ai-chat-wizard/server/app/billing_intervention_ops_test.go`, `examples/100-ai-chat-wizard/server/app/billing_admin_rpc_impl.go`, `examples/100-ai-chat-wizard/server/app/billing_admin_rpc_test.go`, `examples/100-ai-chat-wizard/server/app/workspace_admin_ops.go`, `examples/100-ai-chat-wizard/server/app/workspace_admin_ops_test.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects_test.go`, `examples/100-ai-chat-wizard/server/app/runtime_access_policy_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AdminBillingRPCsSuperuserFlow|AdminBillingRPCsWorkspaceScopeDenied|BillingInterventionOpsSuperuserFlow|BillingInterventionOpsWorkspaceScopeDenied|WorkspaceAdminOpsDetailAndMutations|WorkspaceAdminOpsDenyOutOfScope|AdminMutationRestoreUserPreservesNonDisableAuthBlocks|AdminMutationRestoreWorkspaceDoesNotReopenRevokedOrDisabledOverrides|UserScopedWritesBlockedWhenAuthBlocked)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/billing_intervention_ops.go`, `examples/100-ai-chat-wizard/server/app/billing_intervention_ops_test.go`, `examples/100-ai-chat-wizard/server/app/workspace_admin_ops.go`, `examples/100-ai-chat-wizard/server/app/workspace_admin_ops_test.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects_test.go`, `examples/100-ai-chat-wizard/server/app/runtime_access_policy_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(BillingInterventionOpsSuperuserFlow|BillingInterventionOpsWorkspaceScopeDenied|WorkspaceAdminOpsDetailAndMutations|WorkspaceAdminOpsDenyOutOfScope|AdminMutationRestoreUserPreservesNonDisableAuthBlocks|AdminMutationRestoreWorkspaceDoesNotReopenRevokedOrDisabledOverrides|UserScopedWritesBlockedWhenAuthBlocked)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/workspace_admin_ops.go`, `examples/100-ai-chat-wizard/server/app/workspace_admin_ops_test.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects_test.go`, `examples/100-ai-chat-wizard/server/app/runtime_access_policy_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(WorkspaceAdminOpsDetailAndMutations|WorkspaceAdminOpsDenyOutOfScope|AdminMutationRestoreUserPreservesNonDisableAuthBlocks|AdminMutationRestoreWorkspaceDoesNotReopenRevokedOrDisabledOverrides|UserScopedWritesBlockedWhenAuthBlocked)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/store.go`, `examples/100-ai-chat-wizard/server/app/store_superuser.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_authz.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects_test.go`, `examples/100-ai-chat-wizard/server/app/runtime_access_policy_test.go`, `examples/100-ai-chat-wizard/server/app/notification_flow.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AdminMutationDisableAndRestoreEnforcesImmediateAuthEffects|AdminMutationSuspendAndRestoreWorkspaceEnforcesImmediateAuthEffects|AdminMutationRestoreWorkspaceDoesNotReopenRevokedOrDisabledOverrides|AdminMutationRestoreUserCanExplicitlyRestoreAPIKeys|AdminMutationRestoreWorkspaceCanExplicitlyRestoreOperationalCapabilities)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(UserScopedWritesBlockedWhenDisabled|WorkspaceScopedWritesBlockedWhenSuspended|HandleBackgroundJobsFailsSuspendedWorkspaceQueue)$" -count=1`
...
- completed todo: Add typed workspace-admin query and mutation funcs for workspace detail, suspend workspace, restore workspace, revoke API keys, pause webhooks, and membership review.
- files changed: `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(GetWorkspaceAdminSlices|AdminMutationSuspendAndRestoreWorkspaceEnforcesImmediateAuthEffects|AdminMutationRestoreWorkspaceDoesNotReopenRevokedOrDisabledOverrides|AdminMutationRestoreWorkspaceCanExplicitlyRestoreOperationalCapabilities)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/store_admin.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreAdminUserControlQueries|AdminUserControlRPCs|AdminUserControlRPCsWorkspaceAdminScope)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreAdminDashboardQueries|AdminDashboardRPCs|AdminDashboardRPCsWorkspaceAdminScope|GetWorkspaceAdminSlices|StoreAdminUserControlQueries|AdminUserControlRPCs|AdminUserControlRPCsWorkspaceAdminScope|AdminMutationDisableAndRestoreEnforcesImmediateAuthEffects)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/store_superuser.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AdminMutationDisableAndRestoreEnforcesImmediateAuthEffects|AdminMutationSuspendAndRestoreWorkspaceEnforcesImmediateAuthEffects|AdminMutationRestoreWorkspaceDoesNotReopenRevokedOrDisabledOverrides)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(UserScopedWritesBlockedWhenDisabled|WorkspaceScopedWritesBlockedWhenSuspended|HandleBackgroundJobsFailsSuspendedWorkspaceQueue)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/store_superuser.go`, `examples/100-ai-chat-wizard/server/app/job_flows.go`, `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/runtime_access_policy_test.go`, `examples/100-ai-chat-wizard/server/app/job_flows_test.go`, `examples/100-ai-chat-wizard/server/app/server_helper_branches_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(UserScopedWritesBlockedWhenDisabled|WebhookAndSupportMessageBlockedWhenWorkspaceSuspended|HandleBackgroundJobsFailsBlockedPayloadScope|HandleBackgroundJobsFailsSuspendedWorkspaceQueue|WorkspaceScopedWritesBlockedWhenSuspended|SendDeniedForDisabledUser|SendDeniedForSuspendedWorkspace|AuthAndStoreGuardHelperBranches)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(HandleBackgroundJobsLifecycle|GetSuperuserControlPlaneReturnsExtendedOperationalSnapshot|GetSuperuserSlicesReturnsSnapshot)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run ^$ -bench "BenchmarkResolveBackgroundJobScopeIDs$" -benchtime=100x`
...
- files changed: `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AdminMutationRestoreUserPreservesNonDisableAuthBlocks|AdminMutationRestoreWorkspaceDoesNotReopenRevokedOrDisabledOverrides|AdminMutationDisableAndRestoreEnforcesImmediateAuthEffects|AdminMutationSuspendAndRestoreWorkspaceEnforcesImmediateAuthEffects)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(SendDeniedForDisabledUser|SendDeniedForSuspendedWorkspace|WorkspaceScopedWritesBlockedWhenSuspended|UserScopedWritesBlockedWhenDisabled|DispatchNotificationOutboxPendingFailsSuspendedWorkspaceRows|DispatchNotificationOutboxPendingFailsDisabledUserRows|HandleBackgroundJobsFailsSuspendedWorkspaceQueue)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/admin_audit_events.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard.go`, `examples/100-ai-chat-wizard/server/app/superuser_control.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard_test.go`, `examples/100-ai-chat-wizard/server/app/superuser_control_test.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AdminDashboardRPCs|GetWorkspaceAdminSlices|GetSuperuserSlicesReturnsSnapshot|AdminMutationDisableAndRestoreEnforcesImmediateAuthEffects|AdminMutationSuspendAndRestoreWorkspaceEnforcesImmediateAuthEffects)$" -count=1`
...
- completed todo: Define and enforce the exact runtime effects of user disable vs workspace suspend so chat send, dashboard access, API keys, webhooks, background jobs, and support actions all fail in a consistent way.
- files changed: `examples/100-ai-chat-wizard/server/app/runtime_access.go`, `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/store_superuser.go`, `examples/100-ai-chat-wizard/server/app/notification_flow.go`, `examples/100-ai-chat-wizard/server/app/job_flows.go`, `examples/100-ai-chat-wizard/server/app/runtime_access_policy_test.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects_test.go`, `examples/100-ai-chat-wizard/server/app/store.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(SendDeniedForDisabledUser|SendDeniedForSuspendedWorkspace|WorkspaceScopedWritesBlockedWhenSuspended|DispatchNotificationOutboxPendingFailsSuspendedWorkspaceRows|HandleBackgroundJobsFailsSuspendedWorkspaceQueue|AdminControlMutationScopeBoundaries|RequireAdminMutationConfirmation|AdminMutationDisableAndRestoreEnforcesImmediateAuthEffects|AdminMutationSuspendAndRestoreWorkspaceEnforcesImmediateAuthEffects)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "TestSendStreamsThoughtsAndPersistsConversation$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/sql/store/list_billing_plan_overages.sql`, `examples/100-ai-chat-wizard/sql/store/list_billing_quota_policies.sql`, `examples/100-ai-chat-wizard/sql/store/list_billing_upgrade_triggers.sql`, `examples/100-ai-chat-wizard/sql/store/list_incidents.sql`, `examples/100-ai-chat-wizard/sql/store/list_workspace_cost_guardrails.sql`, `examples/100-ai-chat-wizard/server/app/queries.go`, `examples/100-ai-chat-wizard/server/app/store_superuser.go`, `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/server/app/superuser_control.go`, `examples/100-ai-chat-wizard/server/app/superuser_control_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/proto -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(GetSuperuserSlicesRequiresSURole|GetSuperuserSlicesReturnsSnapshot|GetSuperuserControlPlaneReturnsSnapshot|GetSuperuserControlPlaneReturnsExtendedOperationalSnapshot)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/admin_control_mutation_authz.go`, `examples/100-ai-chat-wizard/server/app/admin_control_mutation_authz_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "TestAdminControlMutationScopeBoundaries$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/admin_mutation_effects.go`, `examples/100-ai-chat-wizard/server/app/admin_mutation_effects_test.go`, `examples/100-ai-chat-wizard/server/app/auth_service.go`, `examples/100-ai-chat-wizard/server/app/admin_scope.go`, `examples/100-ai-chat-wizard/server/app/store_auth.go`, `examples/100-ai-chat-wizard/server/app/store_superuser.go`, `examples/100-ai-chat-wizard/server/app/queries.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard_test.go`, `examples/100-ai-chat-wizard/sql/store/delete_user_auth_block.sql`, `examples/100-ai-chat-wizard/sql/store/delete_user_auth_blocks_by_key.sql`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(RequireAdminMutationConfirmation|AdminMutationDisableAndRestoreEnforcesImmediateAuthEffects|AdminMutationSuspendAndRestoreWorkspaceEnforcesImmediateAuthEffects|AuthorizeAdminMutationActionScopes)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "TestAuthManagerSignupLoginAndTokenRoundTrip$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/proto -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreAdminDashboardQueries|AdminDashboardRPCs|AdminDashboardRPCsWorkspaceAdminScope|GetWorkspaceAdminSlices)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/sql/store/get_admin_dashboard_summary.sql`, `examples/100-ai-chat-wizard/server/app/store_admin.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard_test.go`, `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/server/app/superuser_control.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreAdminDashboardQueries|AdminDashboardRPCs)$" -count=1` (baseline); `go test ./examples/100-ai-chat-wizard/proto -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreAdminDashboardQueries|AdminDashboardRPCs|AdminDashboardRPCsWorkspaceAdminScope)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/superuser_control.go`, `examples/100-ai-chat-wizard/server/app/server_tool_stub.go`, `examples/100-ai-chat-wizard/server/app/server_tool_stub_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(SetServerToolPolicyReturnsUnimplemented|RunServerToolReturnsUnimplemented|SensitiveSuperuserMutationsRequireFreshSession)$" -count=1 -v`
...
- files changed: `examples/100-ai-chat-wizard/client/app/constants.go`, `examples/100-ai-chat-wizard/client/app/auth.go`, `examples/100-ai-chat-wizard/client/app/app.go`, `examples/100-ai-chat-wizard/client/app/route_sync.go`, `examples/100-ai-chat-wizard/client/app/route_sync_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go run ./tools/gwc test -lane wasm -app .\examples\100-ai-chat-wizard\client\main.go -root .\examples\100-ai-chat-wizard`
...
- files changed: `examples/100-ai-chat-wizard/server/app/funnel_first_chat.go`, `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/rpc_more_unit_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(ListAndLoadConversationBranches|SendStreamsThoughtsAndPersistsConversation|ListConversationsSyncsStarterMilestones)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/onboarding_state.go`, `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/rpc_more_unit_test.go`, `examples/100-ai-chat-wizard/server/app/rpc_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(ListConversationsSyncsStarterMilestones|SendStreamsThoughtsAndPersistsConversation|ChatServerAuthRPCs|ChatShellHandlerTracksFirstChatFunnelSteps)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/admin_scope.go`, `examples/100-ai-chat-wizard/server/app/server_gap_branches_test.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard_test.go`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AuthSessionRPCBranchesCoverUnavailableAuthAndLogout|AdminDashboardRPCsRequireSessionAuth|AdminDashboardRPCs|AdminDashboardRPCsWorkspaceAdminScope)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AdminAccessInvalidatesAfterRoleDowngradeAndSessionRevocation|AdminDashboardRPCsRequireSessionAuth|AuthSessionRPCBranchesCoverUnavailableAuthAndLogout)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AdminAccessInvalidatesAfterRoleDowngradeAndSessionRevocation|AdminDashboardRPCsRequireSessionAuth)$" -count=1 -v`
...
- files changed: `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(ChatServerPreferenceAndConversationRPCs|SendAppliesDefaultSystemPromptOnNewConversation|NewChatServiceServerSupportsProviderStubs)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/funnel_first_chat.go`, `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/startup_helpers_test.go`, `examples/100-ai-chat-wizard/server/app/rpc_test.go`, `examples/100-ai-chat-wizard/server/app/testkit_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(ChatServerAuthRPCs|ChatShellHandlerTracksFirstChatFunnelSteps|SendStreamsThoughtsAndPersistsConversation)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/auth_service.go`, `examples/100-ai-chat-wizard/server/app/store_auth.go`, `examples/100-ai-chat-wizard/server/app/queries.go`, `examples/100-ai-chat-wizard/sql/store/create_email_verification_token.sql`, `examples/100-ai-chat-wizard/sql/store/get_email_verification_token_by_hash.sql`, `examples/100-ai-chat-wizard/sql/store/mark_email_verification_token_verified.sql`, `examples/100-ai-chat-wizard/sql/store/create_password_reset_token.sql`, `examples/100-ai-chat-wizard/sql/store/get_password_reset_token_by_hash.sql`, `examples/100-ai-chat-wizard/sql/store/consume_password_reset_token.sql`, `examples/100-ai-chat-wizard/sql/store/update_user_password_hash.sql`, `examples/100-ai-chat-wizard/sql/store/revoke_auth_sessions_by_user.sql`, `examples/100-ai-chat-wizard/server/app/auth_test.go`, `examples/100-ai-chat-wizard/server/app/store_test.go`, `examples/100-ai-chat-wizard/server/app/auth_lifecycle_benchmark_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreAuthFlowTokenLifecycle|AuthManagerPersistedTokenLifecycles)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(AuthManagerSignupLoginAndTokenRoundTrip|AuthManagerPersistedTokenLifecycles|StoreAuthSessionLifecycle|StoreAuthFlowTokenLifecycle)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run ^$ -bench BenchmarkAuthFlowTokenHash -benchmem -count=1`
...
- files changed: `examples/100-ai-chat-wizard/README.md`, `examples/100-ai-chat-wizard/MANUAL_SMOKE.md`, `examples/100-ai-chat-wizard/SCHEMA_TABLES.md`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go run ./tools/gwc files -root .\examples\100-ai-chat-wizard -ext .md`; `rg -n "scripts/dev\.ps1|scripts/dev\.sh|build-client\.ps1|run-server\.ps1|BENCHMARKS\.md" ...`
...
- files changed: `test/playwrightgo/examples/example100_admin_journey_test.go`, `test/playwrightgo/examples/example100_admin_role_guard_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
...
- files changed: `examples/100-ai-chat-wizard/.gitignore`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `Get-Content examples/100-ai-chat-wizard/.gitignore`
...
- files changed: `examples/100-ai-chat-wizard/docs/BUG_REPORT_TEMPLATES.md` (moved), `examples/100-ai-chat-wizard/docs/PERFORMANCE.md` (moved), `examples/100-ai-chat-wizard/README.md`, `examples/100-ai-chat-wizard/DOCS_MAP.md`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go run ./tools/gwc files -root .\examples\100-ai-chat-wizard -ext .md`; `Test-Path` checks confirmed root copies are absent and `docs/` copies exist.
...
- files changed: `examples/100-ai-chat-wizard/server/app/admin_scope.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard.go`, `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run 'Test(ChatShellRoutingHelpers|ChatShellHandler|AdminDashboardRPCs|AdminDashboardRPCsWorkspaceAdminScope)$' -count=1`
...
- files changed: `examples/100-ai-chat-wizard/proto/chat.proto`, `examples/100-ai-chat-wizard/proto/chat.pb.go`, `examples/100-ai-chat-wizard/proto/chat_grpc.pb.go`, `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/startup_helpers_test.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard_test.go`, `examples/100-ai-chat-wizard/client/app/auth.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/proto -count=1`; `$env:CHAT_WIZARD_ROOT='C:\\Users\\Cam\\Desktop\\GoWebComponents\\examples\\100-ai-chat-wizard'; go test ./examples/100-ai-chat-wizard/server/app -run 'Test(ChatServerAuthRPCs|GetSessionReturnsTypedRoleSummary|AdminDashboardRPCs|AdminDashboardRPCsWorkspaceAdminScope)$' -count=1`; `go run ./tools/gwc test -lane wasm -app .\examples\100-ai-chat-wizard\client\main.go -root .\examples\100-ai-chat-wizard`
...
- files changed: `examples/100-ai-chat-wizard/bin/server/chat-wizard-server.exe` (moved), `examples/100-ai-chat-wizard/bin/runtime/legacy-artifacts/chat-wizard-server.exe~` (moved), `examples/100-ai-chat-wizard/bin/runtime/legacy-artifacts/main.wasm` (moved), `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `Get-ChildItem examples/100-ai-chat-wizard/bin -File` confirmed no loose root files remain (`bin_root_files=none`).
...
- files changed: `examples/100-ai-chat-wizard/PERFORMANCE.md` (renamed from `BENCHMARKS.md`), `examples/100-ai-chat-wizard/README.md`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go run ./tools/gwc files -root .\examples\100-ai-chat-wizard -ext .md`; `rg -n "BENCHMARKS\.md" .\examples\100-ai-chat-wizard`
...
- files changed: `examples/100-ai-chat-wizard/server/app/logging.go`, `examples/100-ai-chat-wizard/server/app/coverage_gap_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(ServerLoggerCreatesFileSink|ServerLoggerFailureBranches|GetLogTailReturnsLatestServerLines|GetLogTailSupportsAllSourcesAndFilter|GetLogTailRejectsInvalidSource|GetLogTailRequiresSuperuserAccess)$" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/client/app/auth.go`, `examples/100-ai-chat-wizard/client/app/auth_wasm_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go run ./tools/gwc test -lane wasm -app .\examples\100-ai-chat-wizard\client\main.go -root .\examples\100-ai-chat-wizard`
...
- files changed: `test/playwrightgo/examples/example100_admin_journey_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
...
- files changed: `examples/100-ai-chat-wizard/bin/runtime/logs/server.stderr.log`, `examples/100-ai-chat-wizard/bin/runtime/logs/server.stdout.log`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
...
- files changed: `examples/100-ai-chat-wizard/SCHEMA_TABLES.md`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go run ./tools/gwc files -root .\examples\100-ai-chat-wizard -ext .md`
...
- files changed: `examples/100-ai-chat-wizard/server/app/admin_scope.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard.go`, `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/runtime_helpers_additional_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `$env:CHAT_WIZARD_ROOT='C:\\Users\\Cam\\Desktop\\GoWebComponents\\examples\\100-ai-chat-wizard'; go test ./examples/100-ai-chat-wizard/server/app -run 'Test(ChatShellRoutingHelpers|ChatShellHandler|AdminDashboardRPCs|AdminDashboardRPCsWorkspaceAdminScope)$' -count=1`
...
- files changed: `examples/100-ai-chat-wizard/DOCS_MAP.md`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go run ./tools/gwc files -root .\examples\100-ai-chat-wizard -ext .md`
...
- files changed: `examples/100-ai-chat-wizard/BUG_REPORT_TEMPLATES.md`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go run ./tools/gwc files -root .\examples\100-ai-chat-wizard -ext .md`
...
- files changed: `examples/100-ai-chat-wizard/client/app/helpers.go`, `examples/100-ai-chat-wizard/client/app/app.go`, `examples/100-ai-chat-wizard/client/app/model_preferences.go`, `examples/100-ai-chat-wizard/client/app/conversations.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go run ./tools/gwc test -lane wasm -app .\examples\100-ai-chat-wizard\client\main.go -root .\examples\100-ai-chat-wizard`; `go test -tags playwrightgo ./test/playwrightgo/examples -run "TestExample100(VisitToFirstChatRegression|ScrollToBottomButton)$" -c`
...
- files changed: `examples/100-ai-chat-wizard/server/app/admin_scope.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard.go`, `examples/100-ai-chat-wizard/server/app/admin_dashboard_test.go`, `examples/100-ai-chat-wizard/server/app/store_superuser.go`, `examples/100-ai-chat-wizard/server/app/queries.go`, `examples/100-ai-chat-wizard/sql/store/list_workspace_memberships_by_user.sql`, `examples/100-ai-chat-wizard/sql/store/list_workspace_memberships_by_workspace.sql`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `$env:CHAT_WIZARD_ROOT='C:\\Users\\Cam\\Desktop\\GoWebComponents\\examples\\100-ai-chat-wizard'; go test ./examples/100-ai-chat-wizard/server/app -run 'Test(AdminDashboardRPCs|AdminDashboardRPCsWorkspaceAdminScope)$' -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/authz_entitlement.go`, `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/authz_entitlement_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `$env:CHAT_WIZARD_ROOT='C:\\Users\\Cam\\Desktop\\GoWebComponents\\examples\\100-ai-chat-wizard'; go test ./examples/100-ai-chat-wizard/server/app -run 'Test(BuildSendAccessDeniedStatus|RequireUserEntitlement|RequireUsageBudget|SendRejectsMissingAuthenticatedUserBeforeProviderWork|SendUsesBillingPlanDefaultModel)$' -count=1`; `$env:CHAT_WIZARD_ROOT='C:\\Users\\Cam\\Desktop\\GoWebComponents\\examples\\100-ai-chat-wizard'; go test ./examples/100-ai-chat-wizard/server/app -run '^$' -bench 'Benchmark(BuildSendAccessDeniedStatus|RequireUsageBudget)$' -benchtime=200x`
...
- files changed: `examples/100-ai-chat-wizard/internal/buildinfo/version.go`, `examples/100-ai-chat-wizard/client/app/constants.go`, `examples/100-ai-chat-wizard/client/app/sidebar.go`, `examples/100-ai-chat-wizard/server/app/bootstrap.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go run ./tools/gwc test -lane wasm -app .\examples\100-ai-chat-wizard\client\main.go -root .\examples\100-ai-chat-wizard`; `go test ./examples/100-ai-chat-wizard/internal/buildinfo -count=1`; attempted browser rerun: `go test -tags playwrightgo ./test/playwrightgo/examples -run TestExample100ScrollToBottomButton -v` (blocked by unrelated in-progress server compile failure in worktree: `server.go` undefined `parseBuildUserMemorySignature*` helpers)
...
- files changed: `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/startup_helpers_test.go`, `examples/100-ai-chat-wizard/client/app/app.go`, `examples/100-ai-chat-wizard/client/app/auth.go`, `examples/100-ai-chat-wizard/client/app/route_sync.go`, `examples/100-ai-chat-wizard/client/app/route_sync_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `$env:CHAT_WIZARD_ROOT='C:\\Users\\Cam\\Desktop\\GoWebComponents\\examples\\100-ai-chat-wizard'; go test ./examples/100-ai-chat-wizard/server/app -run '^TestChatServerAuthRPCs$' -count=1`; `$env:GOOS='js'; $env:GOARCH='wasm'; go test -c -o ./bin/examples-100-ai-chat-wizard-client-app.test ./examples/100-ai-chat-wizard/client/app`; `$env:GOOS='js'; $env:GOARCH='wasm'; go test ./examples/100-ai-chat-wizard/client/app -run '^TestShouldRedirectUnauthenticatedRouteToLanding$' -count=1` (blocked on local runner: `%1 is not a valid Win32 application`)
...
- files changed: `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/memory_helpers_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(CustomPromptAndMemoryHelperFunctions|ExtractAndStoreUserMemoriesBranches|ExtractAndStoreUserMemoriesReusesExistingKeys|ExtractAndStoreUserMemoriesLogsLifecycle|ChatServerUserMemoryRPCs|SendStreamsThoughtsAndPersistsConversation|SendAppliesDefaultSystemPromptOnNewConversation)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreSuperuserControlPlaneLifecycle|GetSuperuserControlPlaneReturnsExtendedOperationalSnapshot|GetSuperuserControlPlaneReturnsSnapshot|Auth|DispatchNotificationOutboxPendingLifecycle|HandleBackgroundJobsLifecycle|SendAppliesDefaultSystemPromptOnNewConversation|ExtractAndStoreUserMemoriesReusesExistingKeys)" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/server/app/server.go`, `examples/100-ai-chat-wizard/server/app/server_helpers_test.go`, `examples/100-ai-chat-wizard/server/app/rpc_test.go`, `examples/100-ai-chat-wizard/server/app/rpc_additional_test.go`, `examples/100-ai-chat-wizard/server/app/unit_additional_test.go`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/CHANGELOG.md`
- validation run: `go test ./examples/100-ai-chat-wizard/server/app -run "Test(NormalizationAndPromptHelpers|RPCFallbacksWhenStoreOrProvidersAreUnavailable|MemoryRPCFallbacksWithoutStore|SendAppliesDefaultSystemPromptOnNewConversation|SendStreamsThoughtsAndPersistsConversation)$" -count=1`; `go test ./examples/100-ai-chat-wizard/server/app -run "Test(StoreSuperuserControlPlaneLifecycle|GetSuperuserControlPlaneReturnsExtendedOperationalSnapshot|GetSuperuserControlPlaneReturnsSnapshot|Auth|DispatchNotificationOutboxPendingLifecycle|HandleBackgroundJobsLifecycle|SendAppliesDefaultSystemPromptOnNewConversation)" -count=1`
...
- files changed: `examples/100-ai-chat-wizard/CHANGELOG.md`, `examples/100-ai-chat-wizard/README.md`, `examples/100-ai-chat-wizard/TODO.md`, `examples/100-ai-chat-wizard/DESIGN.md`, `examples/100-ai-chat-wizard/FLOWS.md`, `examples/100-ai-chat-wizard/MANUAL_SMOKE.md`, `examples/100-ai-chat-wizard/SCHEMA_TABLES.md`, `examples/100-ai-chat-wizard/docs/*`, `examples/100-ai-chat-wizard/client/app/*`, `examples/100-ai-chat-wizard/server/app/*`, `examples/100-ai-chat-wizard/sql/store/*`, `examples/100-ai-chat-wizard/proto/*`, `test/playwrightgo/examples/*`, `html/*`, `examples/static/css/tailwind.css`
- validation run: `git diff --stat -- . ':(exclude)third_party/GoGRPCBridge'`; direct readback of `examples/100-ai-chat-wizard/CHANGELOG.md` and `examples/100-ai-chat-wizard/TODO.md`
...
- next suggested todo: Resume the example-100 backlog from `TODO.md` with one focused implementation slice at a time, starting with a typed dashboard or billing surface rather than another broad backlog pass.
 -count=1`; `go run ./tools/gwc test -lane wasm -app .\examples\100-ai-chat-wizard\client\main.go -root .\examples\100-ai-chat-wizard`
- result: Passed. `GetSession` now returns typed auth-bootstrap metadata (`session_status`, session/token identifiers, expiry, and typed role summary), server role scope is resolved into `user`/`workspace_admin`/`superuser`, and the client auth session checker consumes typed status/expiry fields to drive safe fallback decisions.
- residual risk: Role summary is still bootstrap metadata only; dedicated role-aware dashboard IA and post-login route policy wiring are tracked as separate follow-up todos.
- next suggested todo: Enforce persisted token lifecycles for signup verification, password reset, and update-password flows using the new token tables instead of ad hoc state.
