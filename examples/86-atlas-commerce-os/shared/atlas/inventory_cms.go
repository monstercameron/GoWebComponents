...
func inventoryQueueTableRow(item inventorySummaryCard) ui.Node {
	return html.Tr(html.Props{Class: internalTableRowClass() + " align-top"},
		...
		html.Td(html.Props{Class: "px-4 py-4"}, html.Span(html.Props{Class: warehouseStatusClass(item.Status)}, html.Text(strings.ReplaceAll(item.Status, "_", " ")))),
		...
		html.Td(html.Props{Class: "px-4 py-4 text-sm text-slate-400"}, html.Text(item.LastUpdated)),
		html.Td(html.Props{Class: "px-4 py-4"},
			html.Div(html.Props{Class: "grid gap-2"},
...
func skuLaneRosterTable(rows []inventoryRow) ui.Node {
	...
	for _, row := range rows {
		items = append(items, html.Tr(html.Props{Class: internalTableRowClass() + " align-top"},
			html.Td(html.Props{Class: "px-4 py-4"},
			...
			html.Td(html.Props{Class: "px-4 py-4 text-sm text-slate-200"}, html.Text(fmt.Sprintf("%d", row.Available))),
			html.Td(html.Props{Class: "px-4 py-4 text-sm text-slate-200"}, html.Text(fmt.Sprintf("%d", row.Inbound))),
			html.Td(html.Props{Class: "px-4 py-4 text-sm text-slate-200"}, html.Text(fmt.Sprintf("%d days", row.CoverDays))),
			html.Td(html.Props{Class: "px-4 py-4 text-sm text-slate-200"}, html.Text(fmt.Sprintf("%d", row.ReorderUnits))),
			html.Td(html.Props{Class: "px-4 py-4 text-sm text-slate-400"}, html.Text(row.UpdatedAt)),
			html.Td(html.Props{Class: "px-4 py-4"},
