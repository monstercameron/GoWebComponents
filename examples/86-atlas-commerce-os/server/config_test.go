...
func TestFindRepoRoot(parseT *testing.T) {
	...
	parseNested := filepath.Join(parseRepoRoot, "examples", "86-atlas-commerce-os", "server", "data")
...
func TestLoadConfigDefaultsAndEnvOverride(parseT *testing.T) {
	...
	if parseCfg.ExampleRoot != filepath.Join(parseCfg.RepoRoot, "examples", "86-atlas-commerce-os") {
