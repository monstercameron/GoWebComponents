...
- applies numbered startup migrations from `examples/86-atlas-commerce-os/server/data/migrations/`
...
- hydrates the same Atlas page tree in the browser through `examples/86-atlas-commerce-os/client`
